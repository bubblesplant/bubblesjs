...
<template>
  <div class="chart-input relative max-h-250px flex flex-col gap-3px border-1px border-[#0000000f] rounded-16px border-solid bg-[#fff] p-16px">
    <textarea
