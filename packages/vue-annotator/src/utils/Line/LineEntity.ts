import type { Entity } from '../Label/Entity'
import type { LabelList } from '../Label/Label'
import type { TextLine } from './LineText'
...
export class EntityLine {
  ...
  private rtl: boolean
  constructor(textLine: TextLine, rtl = false) {
